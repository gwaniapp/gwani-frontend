...
import { DashboardNav, DASHBOARD_HOME } from "@/features/dashboard/components/DashboardNav";
...
/**
 * Provider dashboard frame, in the design's floating-card style: from `lg` the
				...
				<div className="bg-primary-100/10 px-5 lg:pt-5 lg:pb-7">
					<div className="flex h-16 items-center justify-between lg:h-24.5">
						<div className="flex items-center gap-3 lg:gap-5">
							<Link href={DASHBOARD_HOME} aria-label="Gwani dashboard" className="ml-0.5">
