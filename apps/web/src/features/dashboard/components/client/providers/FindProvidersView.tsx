 ...
 * `useProviderSearch`): a text box (matches provider names, skills and places), a
 ...
 * screen readers everywhere. (The mock's trailing "Filter" chip is gone: there is
 * no further filter the backend supports.)
 */
		...
		<div className="flex flex-col gap-6 lg:gap-8">
			...
			>
				<label className="relative flex-1">
					<span className="sr-only">Search by name, skill or city</span>
